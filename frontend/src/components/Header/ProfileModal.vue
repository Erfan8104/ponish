...
<template>
  <div v-if="isLoggedIn" class="inline-flex items-center">
    ...
    >
      <div
        class="flex h-8 w-8 items-center justify-center rounded-full bg-linear-to-br from-indigo-500 to-cyan-500 font-bold text-white shadow-xs text-xs"
      >
        {{ avatarLabel }}
      </div>
        ...
        >
          ...
          >
            ...
            <div class="flex items-center gap-3 border-b border-slate-800/60 pb-4 mb-3">
              <div
                class="flex h-11 w-11 items-center justify-center rounded-full bg-slate-950 border border-slate-800 text-sm font-bold text-slate-200"
              >
                {{ avatarLabel }}
              </div>
              <div class="flex flex-col text-right">
                <span class="text-sm font-semibold text-slate-100">حساب کاربری شما</span>
            ...
            <div class="space-y-1">
              ...
              >
                <div class="flex items-center gap-2">
                  <UserRoundSettings :size="16" class="text-slate-400" />
